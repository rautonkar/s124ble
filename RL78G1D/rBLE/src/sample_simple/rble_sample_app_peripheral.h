...
/******************************************************************************
 * File Name  : rble_sample_app_peripheral.h
 * Version    : 1.0
 * Description: sample application peripheral role header file
 *
 * Copyright(C) 2012-2016 Renesas Electronics Corporation
 ******************************************************************************/
#ifndef __RBLE_SAMPLE_APP_PERIPHERAL_H__
...
extern ke_state_t app_state[APP_STATE_MAX];

#endif /* __RBLE_SAMPLE_APP_PERIPHERAL_H__ */
