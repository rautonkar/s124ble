...
static void environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_TYPE type)
{
    ...
    case ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE:
        ...
        event.param.cccd_write_evt.value    = (info.value[1] << 8) | info.value[0];
        break;
...
static void environmental_sensing_server_set_data_cmp_handler(RBLE_GATT_EVENT *event)
{
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_DESCRIPTOR_VALUE_CHANGED_CCCD:
        ...
        info.param.es_descriptor_value_changed_char_cccd = (info.value[1] << 8) | info.value[0];
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_APPARENT_WIND_DIRECTION_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_apparent_wind_direction_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_APPARENT_WIND_SPEED_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_apparent_wind_speed_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_DEW_POINT_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_dew_point_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_ELEVATION_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_elevation_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_GUST_FACTOR_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_gust_factor_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_HEAT_INDEX_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_heat_index_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_HUMIDITY_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_humidity_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_IRRADIANCE_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_irradiance_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_POLLEN_CONCENTRATION_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_pollen_concentration_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_RAINFALL_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_rainfall_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_PRESSURE_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_pressure_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_TEMPERATURE_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_temperature_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_TRUE_WIND_DIRECTION_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_true_wind_direction_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_TRUE_WIND_SPEED_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_true_wind_speed_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_UV_INDEX_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_uv_index_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_WIND_CHILL_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_wind_chill_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_BAROMETRIC_PRESSURE_TREND_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_barometric_pressure_trend_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_MAGNETIC_DECLINATION_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_magnetic_declination_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_MAGNETIC_FLUX_DENSITY___2D_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_magnetic_flux_density___2d_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_ES_MAGNETIC_FLUX_DENSITY___3D_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.es_magnetic_flux_density___3d_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
    ...
    case ENVIRONMENTAL_SENSING_HDL_BS_BATTERY_LEVEL_CCCD:
        environmental_sensing_server_write_resp(TRUE);
        info.param.bs_battery_level_char_cccd = (info.value[1] << 8) | info.value[0];
        environmental_sensing_server_send_event(ENVIRONMENTAL_SENSING_SERVER_EVENT_CCCD_WRITE);
        break;
